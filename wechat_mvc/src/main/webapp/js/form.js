...
function rSelects() {
	...
	if(selects[i].className!='nostyle'){
...
function focusInput() {
     ...
     for (var i=0; i < elements.length; i++) {
         if (elements[i].type != "button" && elements[i].type != "submit" && elements[i].type != "reset" ) {	 
             ...
             elements[i].onfocus = function() {this.parentNode.style.backgroundPosition="bottom"; };
             elements[i].onblur = function() { this.parentNode.style.backgroundPosition="top"; };			
         }
...
function focustextarea() {
	var elements1 = document.getElementsByTagName("textarea");{
			 for (var i=0; i < elements1.length; i++) {	 	 
             	elements1[i].onfocus = function() {this.parentNode.style.backgroundPosition="bottom"; };
				elements1[i].onblur = function() { this.parentNode.style.backgroundPosition="top"; };	
