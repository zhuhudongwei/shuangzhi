var regexEnum = 
{
	...
	intege:"^-?[1-9]\\d*$",					//整数
	intege1:"^[1-9]\\d*$",					//正整数
	intege1ornull:"^[0-9]*$",//正整数或空
	intAndZero:"^[0-9]*$", //真正的整数加0
	intAndZeroOrNull:"^[0-9]*$|^\s*$", //真正的整数加0或空
	intege2:"^-[1-9]\\d*$",					//负整数
	num:"^([+-]?)\\d*\\.?\\d+$",			//数字
	...
	decmal6:"^[1-9][0-9]{0,9}(\\.[0-9]+)?$|0$",    //真正非负浮点数或0
	...
	notempty:"^\\S+$",						//非空
	notallemptya:"^\\s*\\S+.+\\S+\\s*$",								//不全是空格(必填)
	notallemptyb:"^.*\\S+.*",								//不全是空格(可空)
