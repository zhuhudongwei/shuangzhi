...
<form action="addArticle" method="post" id="editUserForm" enctype="multipart/form-data">
	<table class="bcc line_add_edit" style="width: 100%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td colspan="3">
				<input type="text" id="title" name="article_title" style="width: 700px;"/>
			</td>
		</tr>
		<tr>
			<td class="tr pt10 w100">内容：</td>
			<td colspan="3">
				<textarea class="tea_e" name="article_content" id="article_content" ></textarea>
			</td>
		</tr>
		
		<tr>
            <td colspan="2"><input type="submit" value="添加" class="w80 h30 b" id="submitForm" name="submitForm"/></td>
            <td colspan="2"><input type="reset" value="重置" class="w80 h30 b" /></td>
		</tr>
	</table>
</form>
</div>
